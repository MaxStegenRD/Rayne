...
function(rayne_get_android_assets_directory _OUT_VARIABLE)
    if(NOT ANDROID_ASSETS_DIRECTORIES)
        message(FATAL_ERROR "ANDROID_ASSETS_DIRECTORIES must be set for Android builds.")
    endif()

    list(GET ANDROID_ASSETS_DIRECTORIES 0 _ANDROID_ASSETS_DIRECTORY)
    string(REGEX REPLACE "^\\[|\\]$" "" _ANDROID_ASSETS_DIRECTORY "${_ANDROID_ASSETS_DIRECTORY}")
    if(NOT _ANDROID_ASSETS_DIRECTORY)
        message(FATAL_ERROR "ANDROID_ASSETS_DIRECTORIES did not contain a usable path.")
    endif()

    cmake_path(CONVERT "${_ANDROID_ASSETS_DIRECTORY}" TO_CMAKE_PATH_LIST _ANDROID_ASSETS_DIRECTORY NORMALIZE)
