...
namespace RN
{
	namespace UI
	{
		...
		Button::Button(const TextAttributes &defaultTextAttributes) :
			_imageNormal(nullptr), _imageHighlight(nullptr), _imageColorNormal(Color::White()), _imageColorHighlight(Color::White()), _backgroundColorNormal(Color::ClearColor()), _backgroundColorHighlight(Color::ClearColor()), _textColorNormal(Color::White()), _textColorHighlight(Color::Gray()), _isHighlighted(false), _wasHighlighted(false)
		{
