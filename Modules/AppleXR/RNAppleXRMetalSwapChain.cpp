...
namespace RN
{
	...
	AppleXRMetalSwapChain::AppleXRMetalSwapChain(const Window::SwapChainDescriptor &descriptor, cp_layer_renderer_t layerRenderer) :
		AppleXRSwapChain(layerRenderer), _drawable(nullptr)
	{
