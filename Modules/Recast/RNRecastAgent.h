...
namespace RN
{
	...
	public:
		...
		public:
			Settings() :
				radius(0.2), height(1.8f), maxAcceleration(5.0f), maxSpeed(2.0f), collisionQueryRange(1.5f), pathOptimizationRange(20.0f), separationWeight(0.1f), /*obstacleAvoidanceType(0),*/ updateFlags(UpdateFlagsAnticipateTurns | UpdateFlagsObstacleAvoidance)
			{
			}
			float radius;
			float height;
