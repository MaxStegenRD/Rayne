...
// ---------------------------
	...
	#define RN_PROFILE_METAL_DECLARE_CONTEXT(ctxVar, device, cmdBuf) ((void)0)
	...
	#define RN_PROFILE_VULKAN_DECLARE_CONTEXT(instance, device, physicalDevice, queue, cmdBuf, instanceProcAddr, deviceProcAddr) ((void)0)
