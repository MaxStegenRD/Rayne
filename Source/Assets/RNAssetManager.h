...
namespace RN
{
	...
	public:
		...
		template<class T>
		AssetLoadFuture GetFutureAssetWithName(const String *name, const Dictionary *settings, WorkQueue *queue = nullptr)
		{
	...
	private:
		...
		AssetLoadFuture __GetFutureMatching(MetaClass *base, String *name);
